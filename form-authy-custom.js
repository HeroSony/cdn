(function() {
    ...
    window.Authy.UI = function() {
        ...
        setupAuthyTokenValidation = function() {
            ...
            token.onblur = function() {
                if (token.value !== "" && token.value.match(/^\d+$/)) {
                    ...
                    return token.style.backgroundColor = "none"
                }
            }
        };
        ...
        setupEvents = function(countriesInput, listId) {
            ...
            countriesInput.onchange = function(event) {
                self.setCountryCode(listId, this.value);
            };
        };
        ...
        buildItem1 = function(classActive, country, listId) {
            var cc, flag, option, name;
            cc = country.country.substring(0, 2).toLowerCase() + country.code;
            option = document.createElement("option");
            option.setAttribute("data-list-id", listId);
            option.setAttribute("value", country.code);
            option.setAttribute("data-name", country.country);
            option.onmouseover = function(event) {
                return setActive(option)
            };
        ...
        setupCountriesDropdown = function(countriesSelect, listId) {
            ...
            classActive = "";
            countriesAutocompleteList = document.getElementById("authy-countries");
            ...
            countriesAutocompleteList.appendChild(option);
            ...
            while (i < countriesList.length) {
                ...
                listItem = buildItem1(classActive, countriesList[i], listId);
            ...
            countriesAutocompleteList.parentNode.appendChild(countryCodeValue);
            setupEvents(countriesAutocompleteList, listId);
        ...
        this.autocomplete = function(obj, hideList) {
            ...
            countryCode = obj.getAttribute("value");
